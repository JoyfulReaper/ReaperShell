...
It is a shell where commands are ordinary C# projects. You can write a command, build it, load it into the running shell, edit it, reload it without restarting, and share command packs through Git.
